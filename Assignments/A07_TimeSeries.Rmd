...
GaringerOzone.daily.ts <- ts(GaringerOzone$Ozone, start = c(fmonth, fyear), frequency = 365)#check frequency and start

GaringerOzone.monthly.ts <- ts(GaringerOzone.monthly$mean_Ozone, start = c(fmonth, fyear), frequency = 12) #I don't understand fmonth, year, and frequency
...
ozone_nonseasonal <- as.data.frame(ozone_monthly_decomp$time.series[,1], ozone_monthly_decomp$time.series[,3], ozone_monthly_decomp$time.series[,4])


#add column with observed data and adding date object
ozone_nonseasonal <- mutate(ozone_Components,
        Observed = GaringerOzone.monthly$Ozone,     
        Date = GaringerOzone.monthly$monthyear)


#16

ozone_nonseasonal <- Kendall::MannKendall(GaringerOzone.monthly.ts)
