...
```{r scrape.the.data, message = FALSE}
#3
...
ggplot(water_df, aes(x = Date, y = Max_Withdrawals)) +
  ...
  labs(title = "Durham Max Water Withdrawals (2020)", x = "Month", y = "Maximum Daily Water Withdrawal (MGD)")
...
```{r construct.a.scraping.function, message = FALSE}
#6.
...
ggplot(Durham_2015, aes(x = Date, y = Max_Withdrawals)) +
  geom_point() +
  scale_x_date(date_labels = "%b", date_breaks = "1 month") +
  labs(title = "Durham Max Water Withdrawals (2015)", x = "Month", y = "Maximum Daily Water Withdrawal (MGD)")
...
water_plot <- ggplot(water_2015)+
  ...
  scale_x_date(date_labels = "%b", date_breaks = "1 month") +
  labs(title = "Max Water Withdrawals (2015)", x = "Month", y = "Maximum Daily Water Withdrawal (MGD)", color = "Water System")
