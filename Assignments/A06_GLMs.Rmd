...
Ha: The mean lake temperature changes with depth in July (Mean temperature across depths in July != 0)
...
> Answer: The figure suggests that temperatures generally decrease with a lower subsurface depth, demonstrating a negative relationship between temperature and depth.  While there is a general downward sloping trend, the temperatures vary significantly with each depth measurement and the results do not show a very good linear trend.
...
```{r anova.model}
#should I incorporate depth somewhere in this model?
