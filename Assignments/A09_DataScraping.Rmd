...
ggplot(water_df, aes(x = Date, y = Max_Withdrawals)) +
  geom_point() +
  labs(title = "Durham Max Water Withdrawals (2020)", x = "Date", y = "Maximum Water Withdrawal (MGD)")
...
ggplot(Durham_2015, aes(x = Date, y = Max_Withdrawals)) +
  geom_point() +
  labs(title = "Durham Max Water Withdrawals (2015)", x = "Date", y = "Maximum Water Withdrawal (MGD)")
