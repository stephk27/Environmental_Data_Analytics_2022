...
ne_floods <- st_read('./Data/Spatial/cb_2018_us_county_20m.shp')%>% 
  filter(STATEFP == 31) #Filter for just NB Counties
...
> ANSWER: The EPSG code is 4269 and this is a ___ coordinate reference system.  THe datum is associated with the North American Datum 1983.
> 
...
> ANSWER: The dec_lat_va column contains the x coordinate values and the dec_long_va column contains the y coordinate values.
> 
...
ne_gage_sf <- ne_gage %>% 
  st_as_sf(coords = c('dec_lat_va','dec_long_va'),
           crs=4326)
