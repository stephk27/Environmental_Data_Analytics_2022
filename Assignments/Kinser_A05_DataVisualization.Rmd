...
NTL_grid <- plot_grid(NTL_temp + theme(legend.position = "none"),
      ...
      nrow = 4, #num of rows
      align = 'h')
      #rel_heights = c(3, 3, 3, 1)) #adjust how much space each plot need and have cells of different sizes
print(NTL_grid)
...
> Answer: For each month that has data, nitrogen and phosphorous concentrations are higher for Peter Lake during all seasons. Temperature at Peter Lake is more variable than for Paul Lake across seasons.  
